...
|----------|------|--------|
| Proposal | `openspec/changes/budget-structure-ui-e2e-debt/proposal.md` | ✅ Complete |
| Spec | `openspec/changes/budget-structure-ui-e2e-debt/spec.md` | ✅ Complete |
| Design | `openspec/changes/budget-structure-ui-e2e-debt/design.md` | ✅ Complete |
| Tasks | `openspec/changes/budget-structure-ui-e2e-debt/tasks.md` | ✅ Complete (19/19 checked) |
| Verify Report | `openspec/changes/budget-structure-ui-e2e-debt/verify-report.md` | ✅ Pass with warnings |
