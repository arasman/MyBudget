...
namespace MyBudget.Features.Migrations
{
    ...
    [Migration("20260813233751_AddBudgetMembershipSoftDelete")]
    partial class AddBudgetMembershipSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyBudget.Features.SharedKernel.Entities.CutRecord", b =>
                {
                    ...
                    b.Property<decimal>("RemainingAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("TotalAvailableAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("TotalBudgetedAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalDeudaEnCurso")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalDeudaEnCursoAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalNegative")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalNegativeAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("TotalNetAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalPositive")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalPositiveAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalRegistered")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal>("TotalRegisteredAlt")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
