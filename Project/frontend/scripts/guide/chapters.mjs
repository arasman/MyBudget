...
export const CHAPTERS = [
  ...
  },
  {
    ...
    images: [
      '01-period-list-empty.png',
      '03-period-create-success.png',
      '06-period-status-success.png',
      '11-line-create-success.png',
      '13-line-edit-inline.png',
      '16-line-delete-success.png',
    ],
    published: true,
  },
  {
    slug: 'budget-execution',
    label: { en: 'Matrix & execution', es: 'Matriz y ejecución' },
    images: [
      '01-matrix-view.png',
      '03-create-validation-error.png',
      '04-create-form-filled.png',
      '06-matrix-updated.png',
      '07-currency-toggle-usd.png',
      '09-collapse-group.png',
    ],
    published: true,
  },
  {
    slug: 'bank-accounts',
    label: { en: 'Bank accounts', es: 'Cuentas bancarias' },
    images: [
      '01-list-empty.png',
      '02-create-form.png',
      '03-create-success.png',
      '06-edit-success.png',
      '08-delete-success.png',
      '10-restore-success.png',
    ],
    published: true,
  },
  {
    slug: 'current-situation',
    label: { en: 'Current situation', es: 'Situación actual' },
    images: [
      '01-draft-form.png',
      '02-form-filled.png',
      '03-save-error.png',
      '04-save-success.png',
      '06-delete-confirm-typed.png',
      '07-delete-success.png',
    ],
    published: true,
  },
  {
    ...
    images: [
      '01-lifetime-trend.png',
      '03-budget-line-empty.png',
      '04-budget-line-selected.png',
      '05-cross-cycle-mode.png',
      '06-insufficient-history.png',
