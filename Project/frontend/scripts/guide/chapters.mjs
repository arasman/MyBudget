...
export const CHAPTERS = [
  ...
  { slug: 'budget-management', label: { en: 'Budgets', es: 'Presupuestos' }, published: false },
  { slug: 'budget-structure-cycles', label: { en: 'Cycles', es: 'Ciclos' }, published: false },
  { slug: 'budget-structure-categories', label: { en: 'Categories', es: 'Categorías' }, published: false },
  {
