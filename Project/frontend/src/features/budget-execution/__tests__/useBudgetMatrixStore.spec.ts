...
vi.mock('@/features/budget-structure/store', () => ({
  useBudgetStructureStore: vi.fn(() => ({
    currentCycle: {
      ...
      periods: [
        { id: 'p1', name: 'Jan', periodNumber: 1, startDate: '2026-01-01', endDate: '2026-01-31', status: 'Open' },
        { id: 'p2', name: 'Feb', periodNumber: 2, startDate: '2026-02-01', endDate: '2026-02-28', status: 'Open' },
        { id: 'p3', name: 'Mar', periodNumber: 3, startDate: '2026-03-01', endDate: '2026-03-31', status: 'Open' },
        { id: 'p4', name: 'Apr', periodNumber: 4, startDate: '2026-04-01', endDate: '2026-04-30', status: 'Open' },
        { id: 'p5', name: 'May', periodNumber: 5, startDate: '2026-05-01', endDate: '2026-05-31', status: 'Open' },
      ],
    },
    periods: [
      { id: 'p1', name: 'Jan', periodNumber: 1, startDate: '2026-01-01', endDate: '2026-01-31', status: 'Open' },
