<template>
  <div class="container mx-auto px-4 py-6">
    ...
    <h2 class="text-xl font-semibold mb-6">{{ t('dashboard.title') }}</h2>
    ...
    <div class="flex flex-col gap-8">
      <section>
        <h3 class="text-lg font-medium mb-3">{{ t('dashboard.lifetime.title') }}</h3>
        <LifetimeTotalsChart :budget-id="budgetId" />
      </section>

      <section>
        <h3 class="text-lg font-medium mb-3">{{ t('dashboard.band.title') }}</h3>
        <TotalsBandChart :budget-id="budgetId" />
      </section>

      <section>
        <h3 class="text-lg font-medium mb-3">{{ t('dashboard.lineSeries.title') }}</h3>
